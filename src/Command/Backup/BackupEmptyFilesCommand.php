...
/**
 * Truncate data files inside a Moodle backup, leaving empty placeholders.
 *
 * Canonical name: backup:empty-files  |  Alias: backup-empty-files
 */
class BackupEmptyFilesCommand extends BaseCommand
{
