...
/**
 * Show detailed information about a Moodle backup file.
 *
 * Replaces Moosh\Command\Generic\Backup\BackupInfo.
 * Canonical name: backup:info  |  Alias: backup-info
 */
class BackupInfoCommand extends BaseCommand
{
