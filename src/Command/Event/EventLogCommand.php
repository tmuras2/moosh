...
class EventLogCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  event:log --courseid 2
                  event:log --userid 2 --since "1 hour ago"
                  event:log --component mod_forum --limit 20
                  event:log --action created --since "2025-01-01"
                HELP);
