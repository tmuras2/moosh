...
/**
 * Modify a badge's properties.
 *
 * Canonical name: badge:mod  |  Alias: badge-mod
 */
class BadgeModCommand extends BaseCommand
{
    ...
    private function resolveHandler(?MoodleVersion $moodleVersion): BaseHandler
    {
        if ($moodleVersion !== null && $moodleVersion->isAtLeast('5.2')) {
            return new BadgeMod52Handler();
        }

        return new BadgeMod51Handler();
    }
}
