 ...
 * Purge caches.
 *
 * Canonical name: cache:purge  |  Aliases: cache-purge, cache-clear
 */
class CachePurgeCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  cache:purge
                  cache:purge --store default_application
                  cache:purge --definition core/coursemodinfo
                HELP);
