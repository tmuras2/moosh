 ...
 *
 * Canonical name: quiz:delete-attempt  |  Alias: quiz-delete-attempts
 */
class QuizDeleteAttemptCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Requires --run to actually delete.

                Examples:
                  quiz:delete-attempt 42
                  quiz:delete-attempt 42 43 44 --run
                HELP);
