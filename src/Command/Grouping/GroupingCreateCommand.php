...
class GroupingCreateCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  grouping:create "Lab Groups" 2 --run
                  grouping:create "Exam Groups" 2 --idnumber EXAM --run
                HELP);
    ...
    {
        return new GroupingCreate51Handler();
    }
}
