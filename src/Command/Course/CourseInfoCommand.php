...
/**
 * Show detailed information about a single course.
 *
 * Replaces Moosh\Command\Moodle45\Course\CourseInfo.
 * Canonical name: course:info  |  Alias: course-info
 */
class CourseInfoCommand extends BaseCommand
{
    ...
    {
        return new CourseInfo51Handler();
    }
}
