...
/**
 * Export a role definition to XML.
 *
 * Canonical name: role:export  |  Alias: role-export
 */
class RoleExportCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Output goes to stdout by default, or to a file with --file.

                Examples:
                  role:export teacher
                  role:export teacher --file=teacher_role.xml
                  role:export teacher --pretty
                HELP);
