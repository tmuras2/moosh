 ...
 *
 * Canonical name: role:delete  |  Alias: role-delete
 */
class RoleDeleteCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  role:delete customrole --run
                  role:delete 15 --run
                  role:delete customrole1 customrole2 --run
                HELP);
