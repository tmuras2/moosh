 ...
 *
 * Replaces Moosh\Command\Moodle39\Auth\AuthList.
 * Canonical name: auth:list  |  Alias: auth-list
 */
class AuthListCommand extends BaseCommand
{
    ...
    private function resolveHandler(?MoodleVersion $moodleVersion): BaseHandler
    {
        if ($moodleVersion !== null && $moodleVersion->isAtLeast('5.2')) {
            return new AuthList52Handler();
        }

        return new AuthList51Handler();
    }
}
