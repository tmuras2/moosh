...
class CategoryImportCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Preserves hierarchy. Skips categories that already exist (by name at same level).

                Examples:
                  category:import categories.xml --run
                  category:import categories.xml --parent 5 --run
                HELP);
