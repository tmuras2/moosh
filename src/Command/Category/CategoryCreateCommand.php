...
/**
 * Create one or more Moodle course categories.
 *
 * Replaces Moosh\Command\Moodle39\Category\CategoryCreate.
 * Canonical name: category:create  |  Alias: category-create
 */
