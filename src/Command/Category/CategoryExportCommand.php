...
class CategoryExportCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Use category ID 0 to export all categories.

                Examples:
                  category:export 0                     (export all)
                  category:export 5                     (export category 5 and children)
                  category:export 0 > categories.xml    (save to file)
                HELP);
    ...
    {
        return new CategoryExport51Handler();
    }
}
