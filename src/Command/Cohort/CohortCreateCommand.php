...
class CohortCreateCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  cohort:create "Class 2025" --run
                  cohort:create "Group A" "Group B" --idnumber GRP --run
                  cohort:create "Faculty Cohort" --category 2 --run
                HELP);
    ...
    {
        return new CohortCreate51Handler();
    }
}
