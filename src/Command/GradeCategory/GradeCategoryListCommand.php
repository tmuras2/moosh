 ...
 *
 * Canonical name: gradecategory:list  |  Alias: gradecategory-list
 */
class GradeCategoryListCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  gradecategory:list 2
                  gradecategory:list 2 -o csv
                  gradecategory:list 2 --id-only
                HELP);
    ...
    {
        return new GradeCategoryList51Handler();
    }
}
