...
/**
 * Dump the Moodle database.
 *
 * Canonical name: sql:dump  |  Alias: sql-dump
 */
class SqlDumpCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                (mysqldump or pg_dump). Output goes to stdout by default.

                Examples:
                  sql:dump > backup.sql
                  sql:dump --file=backup.sql
                  sql:dump --gzip --file=backup.sql.gz
                  sql:dump --tables=user,course
                HELP);
