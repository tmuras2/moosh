...
class GroupCreateCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Examples:
                  group:create "Group A" 2 --run
                  group:create "Group A" "Group B" 2 --run
                  group:create "Lab 1" 2 --idnumber LAB1 --enrolmentkey secret --run
                  group:create "Hidden Group" 2 --visibility 1 --run
                HELP);
