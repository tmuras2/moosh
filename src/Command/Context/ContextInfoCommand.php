 ...
 *
 * Replaces Moosh\Command\Moodle39\Info\DevContext.
 * Canonical name: context:info  |  Alias: context-info
 */
class ContextInfoCommand extends BaseCommand
{
    ...
    {
        return new ContextInfo51Handler();
    }
}
