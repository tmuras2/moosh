...
/**
 * Freeze (lock) one or more contexts.
 *
 * Canonical name: context:freeze  |  Alias: context-freeze
 */
class ContextFreezeCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Use --children to also freeze all child contexts.

                Examples:
                  context:freeze 42 --run
                  context:freeze 5 --level=course --run
                  context:freeze 5 --level=course --children --run
                HELP);
    ...
    {
        return new ContextFreeze51Handler();
    }
}
