...
/**
 * Rebuild all context paths and clean up orphaned instances.
 *
 * Canonical name: context:rebuild  |  Alias: context-rebuild
 */
class ContextRebuildCommand extends BaseCommand
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(<<<'HELP'
                ...
                Similar to running the core context_cleanup_task scheduled task.

                This is a repair operation and is always safe to run.
                HELP);
