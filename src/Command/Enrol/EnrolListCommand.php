...
/**
 * List enrolment methods for a course.
 *
 * Canonical name: enrol:list  |  Aliases: enrol-list, course-enrol-list
 */
class EnrolListCommand extends BaseCommand
{
